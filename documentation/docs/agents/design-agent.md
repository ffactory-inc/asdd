...
| Input | Path | Required |
|---|---|---|
| Validated requirements | `.asdd/specs/[spec-name]/requirements.md` | Mandatory |
| Domain model | `docs/architecture/domain-model.md` | Mandatory |
| State Manifest | `.asdd/state/manifest.json` | Mandatory |
| Steering rules | `.asdd/steering/architecture-rules.md` | Mandatory |
| Existing design | `.asdd/specs/[spec-name]/design.md` | Optional (for revisions) |
...
The Design Agent operates within the constraints defined in `.asdd/steering/architecture-rules.md`. Examples:
