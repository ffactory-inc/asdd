...
| Architecture design | `.cursor/specs/[spec-name]/design.md` | Mandatory |
| Steering rules | `.cursor/rules/` | Mandatory |
| Requirements | `.cursor/specs/[spec-name]/requirements.md` | Mandatory |
...
- Verify against `.cursor/rules/security-rules.md`.
