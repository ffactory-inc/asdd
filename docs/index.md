...
ASDD is paired with the **Human–Agent Agile Manifesto** (v3.0, Agentic Era · 2026): a concise charter for **human judgment plus agentic intelligence**—the same worldview as this document, in manifesto form (preamble, values, principles, roles, phase gates, glossary, and comparison to the 2001 Agile Manifesto).
...
**Full text:** [Human–Agent Agile Manifesto](human–agent-agile-manifesto.md) — all principles (including Hallucination Budget, Reasoning Traces, and governance), accountability tables, and definitions.

---

# 1. Introduction

## 1.1 Traditional Agile Boundaries
...
### 1.2 The Discovery Engine

To address the upstream challenge of requirement quality and domain alignment, ASDD incorporates a **Discovery Engine** (Phases -1 and 0). This engine integrates **Lean Inception** for business alignment and **Domain-Driven Design (DDD)** for structural alignment, ensuring that AI agents receive a solid foundation of intent and language.

For more details, see the [Discovery Engine Documentation](discovery_engine/index.md).
...
ASDD is built on ten principles.

## 4.1 Discovery-Driven Alignment

Before any agent work begins, humans must align on product intent and domain language. ASDD uses **Lean Inception** and **Domain-Driven Design (DDD)** in the Discovery Engine to ensure a shared foundation between the Product Owner, Tech Lead, and AI agents.

## 4.2 Domain-First Design

The **Domain Model** is the central contract of the system. It defines the Ubiquitous Language, Bounded Contexts, and business invariants that all downstream agents must respect. Code is an implementation detail of the domain model.

## 4.3 Ambiguity Is a Bug
...
## 4.5 AI Is a Pilot, Not a Passenger
...
## 4.10 Humans Retain Override Authority
...
flowchart TB
    ...
    subgraph Ph0 ["Phase -1/0: Discovery Engine"]
        DiscoveryEngine[Lean Inception + DDD Workshops]
        DiscoveryAgent[Discovery Agent]
        DiscoveryEngine --> DiscoveryAgent
    end
...
Discovery[Phase -1 · Discovery Engine]
Intent[Phase 0 · Product Intent Approval]
...
## Phase −1 — Discovery Engine (Lean Inception + DDD)

**Purpose:** Align stakeholders and establish the domain foundation before any AI-augmented work begins.

**Activities:**
- **Lean Inception:** 1-week structured workshop to align on vision, personas, features, and MVP.
- **DDD Workshop:** Identification of Ubiquitous Language, Bounded Contexts, and core Domain Events.

**Artifacts:**
- Discovery: `mvp-canvas.md`, `personas.md`, `user-journeys.md`, `features.md`.
- Architecture: `context-map.md`, `domain-model.md` (seed).
...
**Purpose:** Formalize the strategic purpose and obtain PO sign-off.
...
**Exit Gate:** PO approves `intent.md` with a confidence score ≥ 0.85. No Phase 1 work begins without an approved intent document.
