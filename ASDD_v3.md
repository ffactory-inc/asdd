...
## 4.4 Contracts Drive Development

Each phase of the lifecycle produces **formal contracts**.
...
|------------------------|-------------|------------------------------------|
| Product Owner (Shared) | 0.3–0.5 FTE | Business intent & prioritization   |
| Tech Lead              | 1           | Flow, quality, technical alignment |
| Engineers              | 1-3         | Spec-compliant implementation      |
| AI Agent System        | 6-10        |                                    |
...
Production data drives system evolution.

AI analyzes telemetry to propose improvements.
