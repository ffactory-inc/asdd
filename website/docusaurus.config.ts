...
const config: Config = {
  ...
  url: "https://asdd.ffactory.io",
  baseUrl: "/",

  organizationName: "ffactory",
  projectName: "asdd",
    ...
    [
      "classic",
      {
        docs: {
          ...
          routeBasePath: "/",
          editUrl:
            "https://github.com/ffactory/asdd/edit/main/website/",
  ...
  themeConfig: {
    image: "img/asdd-social-card.png",
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/ffactory/asdd",
          label: "GitHub",
          position: "right",
        },
      ],
