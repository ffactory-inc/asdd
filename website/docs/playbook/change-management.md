...
ASDD's repository architecture maps closely to Kiro IDE conventions. Teams using other toolchains should treat the following as **framework-agnostic concepts**:
