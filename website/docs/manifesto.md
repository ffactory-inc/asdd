...
### 13 — Agents must explain their reasoning, not just their output ✦ *New in v3.0*
...
:::info Mechanism
Each agent appends a `reasoning_trace.md` to its output. The phase gate checklist requires TL acknowledgment before the gate passes. Traces are stored in `.kiro/traces/`.
:::

---

### 14 — Governance is as important as capability ✦ *New in v3.0*
...
*Framework: ASDD · Author: Edwin Encinas · AI peer review: Claude (Anthropic) · v3.0*
