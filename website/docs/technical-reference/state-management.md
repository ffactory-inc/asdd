...
**Location:** `.kiro/state/manifest.json`
  ...
  "slices": [
    {
      ...
      "phase_data": {
        "intent": ".kiro/specs/auth/intent.md",
        "requirements": ".kiro/specs/auth/requirements.md",
        "domain_model": "docs/architecture/domain-model.md",
        "design": ".kiro/specs/auth/design.md",
        "tasks": ".kiro/specs/auth/tasks.md"
      },
      "confidence_chain": [
      ...
      "blockers": [],
      "dissent_notices": [],
      "reasoning_traces": [".kiro/traces/SLICE-001-design.md"]
    }
  ],
  "agent_heartbeats": {
    "discovery_agent": {
