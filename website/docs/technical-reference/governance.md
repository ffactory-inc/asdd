...
Thresholds are defined per agent in `.kiro/steering/agent-thresholds.md` and can be adjusted by the Tech Lead.
...
Traces are stored in `.kiro/traces/` and linked in the State Manifest.
