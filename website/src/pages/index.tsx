      ...
      <div className="container">
        ...
        <div className="hero__buttons">
          ...
          <Link
            ...
            to="/manifesto"
            style={{ background: "transparent", borderColor: "#38bdf8", color: "#38bdf8" }}
          >
            Read the Manifesto
          </Link>
        </div>
        <div style={{ marginTop: "3rem", display: "flex", gap: "2rem", justifyContent: "center", flexWrap: "wrap" }}>
          <span style={{ color: "#64748b", fontSize: "0.85rem" }}>✦ v5.0 · Agentic Era 2026</span>
          <span style={{ color: "#64748b", fontSize: "0.85rem" }}>✦ 10 Specialized Agents</span>
          <span style={{ color: "#64748b", fontSize: "0.85rem" }}>✦ 8-Phase Lifecycle</span>
          <span style={{ color: "#64748b", fontSize: "0.85rem" }}>✦ Human-First Governance</span>
        </div>
      </div>
    </header>
  );
