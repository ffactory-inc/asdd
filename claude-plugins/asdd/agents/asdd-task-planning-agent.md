...
| Input | Path | Required |
|---|---|---|
| Architecture design | `.claude/specs/[spec-name]/design.md` | Mandatory — must be status READY |
...
| Existing tasks (if exists) | `.claude/specs/[spec-name]/tasks.md` | Read if resuming |
...
Generate `.claude/specs/[spec-name]/tasks.md` following this structure:
