...
3. **Prior Art:** If a validation report exists at `.claude/specs/[spec-name]/spec-validation-report.md`, read it first to inform your revision.
...
Generate the capability document at `.claude/specs/[spec-name]/capability.md` with this structure:
